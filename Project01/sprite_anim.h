...
int SpriteAnim_RegisterPattern(int textureId, int patternMax, int h_patternMax,double m_seconds_per_pattern,
	const DirectX::XMUINT2& pattern_size, const DirectX::XMUINT2& start_position, bool is_looped = true);
